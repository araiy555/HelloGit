...
<section class="contents__inner2">
				...
				$id = $member['id'];
				 ...
				 $sql = sprintf("SELECT * FROM  douga WHERE member_id = '%s'",
				...
				<?php
				while($douga = mysql_fetch_assoc($record)):
				?>


									<video  id="my-video"width="500" height="200" margin-bottom="100"class="video-js"controls preload="auto"  data-setup="{}">
